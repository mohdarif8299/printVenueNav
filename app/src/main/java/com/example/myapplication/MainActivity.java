...
import com.example.myapplication.Fragment.productCustomize;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onBackPressed() {
        ...
        else if (f instanceof CardFragment||f instanceof PensFragment)
    ...
    private void getData(){
        List<String> title = Arrays.asList("Products For Office","Photo_Gifts","Clothings","Business Cards");
